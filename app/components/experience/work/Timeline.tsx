      ...
      <group>
        <group position={getPoint}>
          ...
          <group position={[0, -0.6, 0]}>
            <Text {...titleProps} fontSize={0.5} maxWidth={4} lineHeight={1.2} position={[0, -diff / 2, 0]}>
              {point.title}
            </Text>
            <Text {...textProps} fontSize={0.2} maxWidth={5} lineHeight={1.2} position={[0, -0.65 - diff, 0]}>
              {point.subtitle}
            </Text>
          </group>
        </group>
